...
namespace CinemaBox.Context.Migrations
{
    ...
    [Migration("20260616054036_InitialDb_V8")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaBox.Domain.Entertainment.Collections.Collection", b =>
                {
                    ...
                    b.Property<int?>("CountCollection")
                        .HasColumnType("int")
                        .HasComment("تعداد فیلم های کالکشن موجود");
                    ...
                    b.Property<int?>("TotalCount")
                        .HasColumnType("int")
                        .HasComment("تعداد کل فیلم های کالکشن");
            ...
            modelBuilder.Entity("CinemaBox.Domain.Managment.Link.UserMovieDisks.UserMovieDisk", b =>
                {
                    ...
                    b.Property<int?>("MovieNumber")
                        .HasColumnType("int")
                        .HasComment("شماره فیلم");

                    b.Property<int?>("MyTime")
                        .HasColumnType("int")
                        .HasComment("زمان فیلم من");

                    b.Property<string>("PositionMovie")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("محل قرارگیری فیلم");

                    b.Property<byte?>("StatusId")
                        .HasColumnType("tinyint")
                        .HasComment("شناسه وضعیت");

                    b.HasKey("Id");

                    b.HasIndex("StatusId");

                    b.ToTable("UserMovieDisks", "Managment");
                });

            modelBuilder.Entity("CinemaBox.Domain.Managment.Link.UserMovieFiles.UserMovieFile", b =>
                {
                    b.Property<string>("MovieId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                    ...
                    b.ToTable("UserMovieFile", "Managment");
                });

            modelBuilder.Entity("CinemaBox.Domain.Managment.Link.UserMovieVideos.UserMovieVideo", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                    ...
                    b.Property<byte?>("QualityId")
                        .HasColumnType("tinyint")
                        .HasComment("شناسه کیفیت");

                    b.Property<byte?>("QualityTypeId")
                        .HasColumnType("tinyint")
                        .HasComment("شناسه  نوع کیفیت");

                    b.Property<string>("Resolution")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("وضوح تصویر");

                    b.Property<bool?>("X265")
                        .HasColumnType("bit")
                        .HasComment("X265");
                    ...
                    b.ToTable("UserMovieVideos", "Managment");
                });
            ...
            modelBuilder.Entity("CinemaBox.Domain.Servers.Servers.Server", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)3,
                            Path = "Images/UserMovie",
                            ServerName = "UserMoviePrimaryImage",
                            ServerTypeId = (byte)3
                        });
                });
            ...
            modelBuilder.Entity("CinemaBox.Domain.Shared.Formats.Format", b =>
                {
                    ...
                    b.Property<string>("FormatName")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("عنوان فرمت");

                    b.HasKey("Id");

                    b.ToTable("Formats", "Shared");
                });
            ...
            modelBuilder.Entity("CinemaBox.Domain.Shared.Qualities.Qualities.Quality", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
                        .HasColumnName("QualityId")
                        .HasComment("شناسه کیفیت کلیدی");
                    ...
                    b.Property<string>("QualityName")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("عنوان کیفیت");

                    b.HasKey("Id");

                    b.ToTable("Qualities", "Shared");
            ...
            modelBuilder.Entity("CinemaBox.Domain.Shared.Qualities.QualityTypes.QualityType", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
                        .HasColumnName("QualityTypeId")
                        .HasComment("شناسه نوع کیفیت کلیدی");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<byte>("Id"));

                    b.Property<string>("QualityTypeName")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("عنوان نوع کیفیت");

                    b.HasKey("Id");

                    b.ToTable("QualityTypes", "Shared");

                    b.HasData(
                        new
                        {
                            Id = (byte)1,
                            QualityTypeName = "BluRay"
                        },
                        new
                        {
                            Id = (byte)2,
                            QualityTypeName = "WebDl"
                        });
                });
            ...
            modelBuilder.Entity("CinemaBox.Domain.Managment.Link.UserMovieDisks.UserMovieDisk", b =>
                {
                    b.HasOne("CinemaBox.Domain.Entertainment.Movies.Movie", "Movie")
                        .WithMany("UserMovieDisks")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CinemaBox.Domain.Shared.Statuses.Status", "Status")
                        .WithMany("UserMovieDisks")
            ...
            modelBuilder.Entity("CinemaBox.Domain.Managment.Link.UserMovieVideos.UserMovieVideo", b =>
                {
                    ...
                    b.HasOne("CinemaBox.Domain.Shared.Qualities.Qualities.Quality", "Quality")
                        .WithMany("UserMovieVideos")
                        .HasForeignKey("QualityId");

                    b.HasOne("CinemaBox.Domain.Shared.Qualities.QualityTypes.QualityType", "QualityType")
                        .WithMany("UserMovieVideos")
            ...
            modelBuilder.Entity("CinemaBox.Domain.Entertainment.Movies.Movie", b =>
                {
                    ...
                    b.Navigation("UserMovieFile");

                    b.Navigation("UserMovieVideos");
                });
