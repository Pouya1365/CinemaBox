namespace CinemaBox.Presentation.Person.MainPeople
{
    partial class Frm_MainPeople
    {
        ...
        private void InitializeComponent()
        {
            ...
            Flw_ShowPeople = new FlowLayoutPanel();
            ...
            Pnl_Search.Size = new Size(1228, 100);
            Pnl_Search.TabIndex = 9;
            // 
            // Flw_ShowPeople
            // 
            Flw_ShowPeople.AutoScroll = true;
            Flw_ShowPeople.Location = new Point(5, 138);
            Flw_ShowPeople.Name = "Flw_ShowPeople";
            Flw_ShowPeople.Size = new Size(1225, 485);
            Flw_ShowPeople.TabIndex = 8;
            Flw_ShowPeople.Scroll += Flw_ShowPeople_Scroll;
            Flw_ShowPeople.Layout += Flw_ShowPeople_Layout;
            // 
            // Frm_MainPeople
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(1232, 627);
            Controls.Add(Pnl_Search);
            Controls.Add(Flw_ShowPeople);
            Name = "Frm_MainPeople";
            Text = "Frm_MainPeople";
            Controls.SetChildIndex(Flw_ShowPeople, 0);
        ...
        private FlowLayoutPanel Flw_ShowPeople;
    }
}