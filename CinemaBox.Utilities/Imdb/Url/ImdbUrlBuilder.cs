...
public static class ImdbUrlBuilder
{
    ...
    {
        string baseUrl = $"https://www.imdb.com/title/{imdbId}/";
    ...
    {
        string baseUrl = $"https://www.imdb.com/name/{imdbId}/";
    ...
    {
        string baseUrl = $"https://www.imdb.com/find?q={Uri.EscapeDataString(movieName)}/";
        return baseUrl;
    }
}
