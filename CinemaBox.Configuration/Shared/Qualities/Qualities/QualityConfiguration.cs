...
public class QualityConfiguration : IEntityTypeConfiguration<Quality>
{
    public void Configure(EntityTypeBuilder<Quality> builder)
    {
        ...
        builder.HasData(new Quality { Id = 1, QualityName = "2160" }, new Quality { Id = 2, QualityName = "1080" }, new Quality { Id = 3, QualityName = "1280" }, new Quality { Id = 4, QualityName = "720" }, new Quality { Id = 5, QualityName = "480" });
    }
}